  ...
  <div class="flex">
    ...
    <div class="pl-8 flex flex-col">
      ...
      <div class="mt-3 gap-x-5 flex items-center">
        ...
        <button v-else
          class="w-28 button rounded-full  text-teal-600"
        >
...
const isArtistLike =  computed(()=>{
 let index = _.findIndex(artists.value, (o)=>{ return o.artistId == props.artistDetail.artistId })
